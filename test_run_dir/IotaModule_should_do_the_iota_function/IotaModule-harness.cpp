...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/users/tw295/590/cs590-sp2023-lab1/test_run_dir/IotaModule_should_do_the_iota_function/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 26 : value = dut->io_round; break;
      case 27 : value = dut->io_state_o_0; break;
      case 28 : value = dut->io_state_o_1; break;
      case 29 : value = dut->io_state_o_2; break;
      case 30 : value = dut->io_state_o_3; break;
      case 31 : value = dut->io_state_o_4; break;
      case 32 : value = dut->io_state_o_5; break;
      case 33 : value = dut->io_state_o_6; break;
      case 34 : value = dut->io_state_o_7; break;
      case 35 : value = dut->io_state_o_8; break;
      case 36 : value = dut->io_state_o_9; break;
      case 37 : value = dut->io_state_o_10; break;
      case 38 : value = dut->io_state_o_11; break;
      case 39 : value = dut->io_state_o_12; break;
      case 40 : value = dut->io_state_o_13; break;
      case 41 : value = dut->io_state_o_14; break;
      case 42 : value = dut->io_state_o_15; break;
      case 43 : value = dut->io_state_o_16; break;
      case 44 : value = dut->io_state_o_17; break;
      case 45 : value = dut->io_state_o_18; break;
      case 46 : value = dut->io_state_o_19; break;
      case 47 : value = dut->io_state_o_20; break;
      case 48 : value = dut->io_state_o_21; break;
      case 49 : value = dut->io_state_o_22; break;
      case 50 : value = dut->io_state_o_23; break;
      case 51 : value = dut->io_state_o_24; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/users/tw295/590/cs590-sp2023-lab1/test_run_dir/IotaModule_should_do_the_iota_function/IotaModule.vcd";
