...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/users/tw295/590/cs590-sp2023-lab1/test_run_dir/Sha3Module_should_do_SHA3/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_message_valid = u; break;
      case 2 : dut->io_message_bits_0 = u; break;
      case 3 : dut->io_message_bits_1 = u; break;
      case 4 : dut->io_message_bits_2 = u; break;
      case 5 : dut->io_message_bits_3 = u; break;
      case 6 : dut->io_message_bits_4 = u; break;
      case 7 : dut->io_message_bits_5 = u; break;
      case 8 : dut->io_message_bits_6 = u; break;
      case 9 : dut->io_message_bits_7 = u; break;
      case 10 : dut->io_message_bits_8 = u; break;
      case 11 : dut->io_message_bits_9 = u; break;
      case 12 : dut->io_message_bits_10 = u; break;
      case 13 : dut->io_message_bits_11 = u; break;
      case 14 : dut->io_message_bits_12 = u; break;
      case 15 : dut->io_message_bits_13 = u; break;
      case 16 : dut->io_message_bits_14 = u; break;
      case 17 : dut->io_message_bits_15 = u; break;
      case 18 : dut->io_message_bits_16 = u; break;
      case 19 : dut->io_hash_ready = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_message_valid; break;
      case 2 : value = dut->io_message_bits_0; break;
      case 3 : value = dut->io_message_bits_1; break;
      case 4 : value = dut->io_message_bits_2; break;
      case 5 : value = dut->io_message_bits_3; break;
      case 6 : value = dut->io_message_bits_4; break;
      case 7 : value = dut->io_message_bits_5; break;
      case 8 : value = dut->io_message_bits_6; break;
      case 9 : value = dut->io_message_bits_7; break;
      case 10 : value = dut->io_message_bits_8; break;
      case 11 : value = dut->io_message_bits_9; break;
      case 12 : value = dut->io_message_bits_10; break;
      case 13 : value = dut->io_message_bits_11; break;
      case 14 : value = dut->io_message_bits_12; break;
      case 15 : value = dut->io_message_bits_13; break;
      case 16 : value = dut->io_message_bits_14; break;
      case 17 : value = dut->io_message_bits_15; break;
      case 18 : value = dut->io_message_bits_16; break;
      case 19 : value = dut->io_hash_ready; break;
      case 20 : value = dut->io_message_ready; break;
      case 21 : value = dut->io_hash_valid; break;
      case 22 : value = dut->io_hash_bits_0; break;
      case 23 : value = dut->io_hash_bits_1; break;
      case 24 : value = dut->io_hash_bits_2; break;
      case 25 : value = dut->io_hash_bits_3; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/users/tw295/590/cs590-sp2023-lab1/test_run_dir/Sha3Module_should_do_SHA3/Sha3Accel.vcd";
