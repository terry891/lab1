...
#ifndef VERILATED_VRHOPIMODULE_H_
#define VERILATED_VRHOPIMODULE_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"

class VRhoPiModule__Syms;
class VRhoPiModule___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class VRhoPiModule VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    VRhoPiModule__Syms* const vlSymsp;
  ...
  public:
    ...
    VRhoPiModule___024root* const rootp;
    ...
    explicit VRhoPiModule(VerilatedContext* contextp, const char* name = "TOP");
    explicit VRhoPiModule(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VRhoPiModule();
  private:
    VL_UNCOPYABLE(VRhoPiModule);  ///< Copying not allowed
