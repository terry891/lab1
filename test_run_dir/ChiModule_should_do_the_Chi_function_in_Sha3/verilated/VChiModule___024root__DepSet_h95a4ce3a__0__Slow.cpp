...
VL_ATTR_COLD void VChiModule___024root___eval_initial(VChiModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root___eval_initial\n"); );
}

void VChiModule___024root___combo__TOP__0(VChiModule___024root* vlSelf);

VL_ATTR_COLD void VChiModule___024root___eval_settle(VChiModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root___eval_settle\n"); );
    // Body
    VChiModule___024root___combo__TOP__0(vlSelf);
}

VL_ATTR_COLD void VChiModule___024root___final(VChiModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root___final\n"); );
}

VL_ATTR_COLD void VChiModule___024root___ctor_var_reset(VChiModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VChiModule___024root___configure_coverage(VChiModule___024root* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root___configure_coverage\n"); );
    // Body
