...
#ifndef VERILATED_VRHOPIMODULE___024ROOT_H_
#define VERILATED_VRHOPIMODULE___024ROOT_H_  // guard
...
class VRhoPiModule___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VRhoPiModule___024root(VRhoPiModule__Syms* symsp, const char* name);
    ~VRhoPiModule___024root();
    VL_UNCOPYABLE(VRhoPiModule___024root);
