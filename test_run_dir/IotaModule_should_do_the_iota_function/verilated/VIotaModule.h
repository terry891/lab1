...
#ifndef VERILATED_VIOTAMODULE_H_
#define VERILATED_VIOTAMODULE_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"

class VIotaModule__Syms;
class VIotaModule___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class VIotaModule VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VIotaModule___024root* const rootp;
    ...
    explicit VIotaModule(VerilatedContext* contextp, const char* name = "TOP");
    explicit VIotaModule(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VIotaModule();
  private:
    VL_UNCOPYABLE(VIotaModule);  ///< Copying not allowed
