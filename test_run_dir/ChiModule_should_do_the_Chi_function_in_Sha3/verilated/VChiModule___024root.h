...
#ifndef VERILATED_VCHIMODULE___024ROOT_H_
#define VERILATED_VCHIMODULE___024ROOT_H_  // guard
...
class VChiModule___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VChiModule___024root(VChiModule__Syms* symsp, const char* name);
    ~VChiModule___024root();
    VL_UNCOPYABLE(VChiModule___024root);
