...
VL_ATTR_COLD void VIotaModule___024root___eval_initial(VIotaModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VIotaModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIotaModule___024root___eval_initial\n"); );
}

void VIotaModule___024root___combo__TOP__0(VIotaModule___024root* vlSelf);

VL_ATTR_COLD void VIotaModule___024root___eval_settle(VIotaModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VIotaModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIotaModule___024root___eval_settle\n"); );
    // Body
    VIotaModule___024root___combo__TOP__0(vlSelf);
}

VL_ATTR_COLD void VIotaModule___024root___final(VIotaModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VIotaModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIotaModule___024root___final\n"); );
}

VL_ATTR_COLD void VIotaModule___024root___ctor_var_reset(VIotaModule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VIotaModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIotaModule___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->io_round = VL_RAND_RESET_I(5);
}

VL_ATTR_COLD void VIotaModule___024root___configure_coverage(VIotaModule___024root* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VIotaModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIotaModule___024root___configure_coverage\n"); );
    // Body
