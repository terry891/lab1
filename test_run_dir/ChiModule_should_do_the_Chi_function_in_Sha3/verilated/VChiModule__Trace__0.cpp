...
void VChiModule___024root__trace_chg_sub_0(VChiModule___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VChiModule___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VChiModule___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VChiModule___024root__trace_chg_sub_0(VChiModule___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root__trace_chg_sub_0\n"); );
    // Init
...
void VChiModule___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VChiModule___024root__trace_cleanup\n"); );
    // Init
    VChiModule___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VChiModule___024root*>(voidSelf);
    VChiModule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
